...
import type { CardItemDetailsScreenProps } from '../types/navigation';
import { TriggeringView, ImageHeaderScrollView } from 'react-native-image-header-scroll-view';

const MIN_HEIGHT = Platform.OS === 'ios' ? 90 : 55;
const MAX_HEIGHT = 350;

const CardItemDetails = ({ route }: CardItemDetailsScreenProps) => {
	...
	return (
		<View style={styles.container}>
			...
			<ImageHeaderScrollView
				...
				headerImage={{ uri: itemData.image }}
				renderForeground={() => (
				...
				<TriggeringView
					...
					<View
						...
						<View
							...
							<Icon name="star" size={16} color="#FF6347" />
              ...
              <View style={styles.categoryContainer} key={index}>
				...
				<View style={[styles.section, { height: 250 }]}>
					<MapView
						...
						<Marker
							coordinate={{ latitude: itemData.coordinate.latitude, longitude: itemData.coordinate.longitude }}
